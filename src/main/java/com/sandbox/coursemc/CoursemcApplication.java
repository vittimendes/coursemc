...
public class CoursemcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Category cat3 = new Category(null, "Cama/Banho");
		Category cat4 = new Category(null, "Perfume");
		Category cat5 = new Category(null, "Jogos");
		Category cat6 = new Category(null, "Celular");
		Category cat7 = new Category(null, "TV");
